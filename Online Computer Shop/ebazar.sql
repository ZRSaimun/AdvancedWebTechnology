...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2020 at 05:13 PM
...
(3, 13, 'cc', 'customer@gmail', 'fgfgdfg', '2020-11-03', 555555, 0, 'regular', 100, 'imagesssss', 1111111);
...
(1, 1, 12, 10, 2, 'pending', 1, '2020-11-09', 50, 30),
(2, 1, 1, 10, 4, 'pending', 1, '2020-12-16', 30, 20),
(3, 3, 2, 10, 555, 'deliverd', 1, '2020-12-16', 30, 20),
(4, 1, 2, 10, 3333, 'cancel', 1, '2020-12-16', 30, 20),
(5, 1, 2, 10, 3, 'deliverd', 1, '2020-12-16', 30, 20),
(6, 1, 2, 10, 2, 'deliverd', 1, '2020-12-16', 30, 20),
(7, 1, 2, 13, 2, 'deliverd', 1, '2020-12-16', 30, 20),
(8, 1, 2, 10, 3, 'deliverd', 1, '2020-12-16', 30, 20),
(9, 1, 2, 10, 3, 'cancel', 1, '2020-12-16', 30, 20),
(10, 1, 2, 13, 2, 'deliverd', 1, '2020-12-16', 100, 20);
...
(10, 2, 'rrrrrrrssssssssss', 11, 10, NULL, '/pictures/90a375fb511aa277dcbdfd9049c74f91.jpg', 0, 'rr', 1, 1),
(13, 2, 'retailar', 76, 5, NULL, '/pictures/image_1606026098363.jpg', 0, 'rrrrrrrrrrrrrrrrrrrrr', 1, 1),
(14, 1, 'qqqqqq', 4, 66666, NULL, 'imageee', 0, 'ghfghfghfghfgh', 0, 0),
(15, 1, 'ddd', 33, 324, NULL, '	\r\n/pictures/image_1605969111562.jpg\r\n', 0, 'fdgsdfgsfdg', 1, 0),
(30, 2, 'fgf', 87, 67, 3, '/pictures/image_1606167497258.png', 0, 'jklkjl', 1, 1),
(32, NULL, '', 0, 0, NULL, 'imageee', 0, '', 0, 0),
(33, NULL, '', 0, 0, NULL, 'imageee', 0, '', 0, 0),
(34, NULL, 'prooooooo', 111, 111, NULL, 'imageee', 0, 'gggggggggggggggggg', 0, 0),
(35, 2, 'balis', 21, 210, 4, '/pictures/image_1606167464281.png', 0, 'ghum vlo hobe', 1, 0),
(36, 2, 'tgh', 65, 76, 2, '/pictures/image_1606200071089.jpg', 0, 'ytfgf', 0, 0),
(37, 2, 'ystgsfs', 76, 76, 2, '/pictures/image_1606201938293.jpg', 0, 'fysagd', 0, 0);
...
--
-- Dumping data for table `retailsellerpi`
--

INSERT INTO `retailsellerpi` (`retailseller_id`, `user_id`, `name`, `email`, `address`, `dob`, `phone_no`, `level`, `selling_point`, `profile_pic`) VALUES
(2, 2, 'kuddos', 'rseller@gmail.com', 'Bashundhara', '0000-00-00', 0, 0, 0, '/pictures/seller.jpg'),
(1234, 1234, 'retail seller', 'rseller@gmail.com', 'rrrrrrrrrrrsssssssssssss', '2020-11-04', 1944253634, 947367784, 3455, '/pictures/images.jpg'),
(12345, 1234, 'retail seller', 'rseller@gmail.com', 'rrrrrrrrrrrsssssssssssss', '2020-11-04', 1944253634, 947367784, 3455, '/pictures/login2.jpg');
...
(2, 2, 'sad', 'email@gm', 'njkj', '2020-11-17', 544664, '/pictures/image_1605969111562.jpg', 'huojkln', 1, 10, 1, 1);
...
(1, 'email@gm', '1', 'SELLER'),
(2, 'email@gm', '1', 'RETAILSELLER'),
(12, 'customer@gmail', '1', 'CUSTOMER'),
(13, 'customer1@gmail', '1', 'CUSTOMER'),
(1234, 'rseller@gmail.com', '123', 'RETAILSELLER'),
(12345, 'rseller@gmail.com', '123', 'RETAILSELLER');
...
--
ALTER TABLE `catagory`
  MODIFY `catagory_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `retailsellerpi`
  MODIFY `retailseller_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12346;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12346;
